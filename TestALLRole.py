...
Ob_Al = TestCase('ALLOW-OBLIGATION', ObligationAllowSteps, '')
...
ViewAndPrint09013Steps = [
    #{'func': Utils.login, 'args': [Roles.ADMIN]},
    {'func': Obligation.view_and_print_09013, 'args': None}
    #{'func': Utils.close_browser, 'args': None}
]
Vw_Pr_13 = TestCase('VIEW-AND-PRINT-09013', ViewAndPrint09013Steps, '')
...
FreezeSteps = [
    #{'func': Utils.login, 'args': [Roles.ADMIN]},
    {'func': FreezeUnFreeze.freeze, 'args': None},
    #{'func': Utils.close_browser, 'args': None}
]

Fre = TestCase('FREEZE', FreezeSteps, '')
...
#Un_Fr = TestCase('UN-FREEZE', UnFreezeSteps, '').run()
...
HistoryObligationPrint09013Steps = [
    #{'func': Utils.login, 'args': [Roles.ADMIN]},
    {'func': Obligation.history_obligation_print_09013, 'args': None},
    #{'func': Utils.close_browser, 'args': None}
]

Hi_Ob_Pr_13 = TestCase('HISTORY-OBLIGATION-PRINT=09013', HistoryObligationPrint09013Steps, '')
...
Create_PayrollsSteps = [
    #{'func': Utils.login, 'args': [Roles.ADMIN]},
    {'func': Obligation.create_payrolls, 'args': None},
    #{'func': Utils.close_browser, 'args': None}
]

Cr_Pys = TestCase('CREATE_PAYROLLS', Create_PayrollsSteps, '')

TestGroup('TEST_CROUP_ALL_ROLL', [Ob_Cr, Ob_Up, Ob_Al, Pa_Ov, Ob_Ca, Cr_Py_Ob, Cr_Py, Up_Py, Pa_Py_Co, Ca_Py, In_Ov, De_Ov, Vw_Ob, Pr_Py, Se_All,
                                  Ob_Cr_Bar, Py_Cr_Bar, Set_Off, Fre, Vw_Pr_93, Vw_Pr_13, Vw_Op_Db, Hi_Ob_Pr_93, Hi_Ob_Pr_13 , Hi_Py_Pr, Vw_0_Py_Pr, Ar_Co_Py, Ar_Co_Ob,
