...
createObligationSteps = [
    {'func': Utils.login, 'args': [Roles.CAP_CMPDEC]},
...
PayPayrollAndConfirmSteps = [
    #{'func': Utils.login, 'args': [Roles.CMPDEC]},
    {'func': Payroll.create_payroll, 'args': None},
    {'func': Logout.logout, 'args': None},
    {'func': Utils.login, 'args': [Roles.CAP_ALL]},
...
TestGroup('TEST_CROUP_CMPDEC_ROLL',
          [Ob_Cr, Ob_Up, Pa_Ov, Ob_Ca, Cr_Py_Ob, Cr_Py, Up_Py, Pa_Py_Co, Ca_Py, Vw_Ob, Pr_Py, Se_All,
